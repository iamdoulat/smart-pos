        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl md:text-3xl font-black bg-gradient-to-r from-amber-500 via-orange-600 to-rose-500 bg-clip-text text-transparent tracking-tighter uppercase italic leading-none mb-1">
                            Brands List
                        </h2>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        <thead className="bg-[#E9EDF2] dark:bg-zinc-800/80 text-zinc-900 dark:text-zinc-100 font-bold border-b border-zinc-200 dark:border-zinc-700">
                            <tr>
                                <th className="px-6 py-4 uppercase tracking-wider text-xs">Brand Name</th>
                                                    ...
                                                    <AlertDialog>
                                                        ...
                                                        <AlertDialogContent className="rounded-[2.5rem] border-0 shadow-2xl p-0 overflow-hidden">
                                                            <div className="bg-red-500 p-8 text-white">
                                                                ...
                                                                <AlertDialogTitle className="text-2xl font-black italic tracking-tighter uppercase leading-none">Delete Brand?</AlertDialogTitle>
                    ...
                    <div className="relative ml-auto h-full w-full max-w-sm bg-white dark:bg-zinc-950 shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
                        ...
                        <div className="p-8 space-y-8 flex-1">
                            <div className="flex items-center justify-between">
                                <h3 className="text-2xl font-black italic tracking-tighter uppercase leading-none bg-gradient-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent">
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <label className="text-xs font-black text-zinc-400 uppercase tracking-widest leading-none">Brand Name</label>
                                    <Input
                        ...
                        <div className="p-8 border-t border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950/50">
                            <Button
                                onClick={handleSave}
                                disabled={saving}
                                className="w-full rounded-2xl h-14 font-black bg-gradient-to-r from-amber-500 via-orange-600 to-amber-500 text-white border-0 shadow-xl shadow-orange-500/25 uppercase italic tracking-tighter hover:scale-[1.02] transition-all flex items-center justify-center gap-3"
                            >
